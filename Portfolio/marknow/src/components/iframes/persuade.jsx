          ...
          <div>
            <section id="site">
              <div class="two-columns">
                <div class="img-div">
                  <picture>
                    <source media="(min-width: 1200px)" srcset="../img/insight-img.jpg" />
                    <img src="../img/mobile-insight-img.jpg" alt="Build your business online" />
                  </picture>
                </div>
                ...
                <div class="two-columns" style="flex-flow: column nowrap;">
                  ...
                  <button class="prim-button" style="background: var(--sec);">
                    <a href="">
                      Start now
                    </a>
                  </button>
